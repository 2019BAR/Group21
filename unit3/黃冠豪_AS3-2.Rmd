...
CocaCola$StockPrice[37]
which.min(CocaCola$StockPrice)
CocaCola$StockPrice[123]
#
```
...
lines(IBM$Date,IBM$StockPrice,type="l",col='orange')
lines(GE$Date,GE$StockPrice,type="l",col='green')
lines(Boeing$Date,Boeing$StockPrice,type="l",col='purple')
...
abline(v=as.Date(c("1997-12-01")), lwd=1)
#
```
ProcterGamble和Boeing在1997年9月到1997年11月呈現遞減趨勢。
...
mean(IBM$StockPrice)>tapply(IBM$StockPrice,months(IBM$Date),mean)
