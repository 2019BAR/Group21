...
CocaCola$Date[which.max(CocaCola$StockPrice)]  #highest stock price in 1973
CocaCola$Date[which.min(CocaCola$StockPrice)]  #lowest stock price in 1980
```
...
#Procter and Gamble dropped more than Coca-Cola
```
...
lines(ProcterGamble$Date, ProcterGamble$StockPrice)
lines(Boeing$Date,Boeing$StockPrice,col="orange")
abline(v=as.Date(c("1997-09-01")), lwd=2, col="purple")
abline(v=as.Date(c("1997-11-01")), lwd=2, col="purple")
...
lines(ProcterGamble$Date, ProcterGamble$StockPrice)
lines(Boeing$Date,Boeing$StockPrice,col="orange")
abline(v=as.Date(c("2004-01-01")), lwd=2, col="brown")
abline(v=as.Date(c("2005-01-01")), lwd=2, col="brown")
#Boeing
```
