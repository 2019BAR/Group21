...
```{r}
plot(date,GE$StockPrice,type = "l")
plot(GE$Date,GE$StockPrice,type = "l")
plot(CocaCola$Date,GE$StockPrice,type = "l")
plot(ProcterGamble$Date,GE$StockPrice,type = "l")
plot(Boeing$Date,GE$StockPrice,type = "l")
```
...
abline(v=as.Date(c("1983/1/1")),lwd=2)
...
lines(ProcterGamble$Date[301:432],ProcterGamble$StockPrice[301:432],col="grey")
lines(date[301:432],IBM$StockPrice[301:432],col="pink")
lines(GE$Date[301:432],GE$StockPrice[301:432])
lines(Boeing$Date[301:432],Boeing$StockPrice[301:432],col="red")
abline(v=as.Date(c("2000-03-01")), lwd=2)

plot(CocaCola$Date, CocaCola$StockPrice, type="l", col="green", ylim=c(0,210))
lines(ProcterGamble$Date,ProcterGamble$StockPrice,col="grey")
lines(date,IBM$StockPrice,col="pink")
...
lines(GE$Date[301:432],GE$StockPrice[301:432])
lines(Boeing$Date[301:432],Boeing$StockPrice[301:432],col="red")
abline(v=as.Date(c("1997/9/1")),lwd=2)
abline(v=as.Date(c("1997/11/1")),lwd=2)
```
...
abline(v=as.Date(c("2005/1/1")),lwd=2)
```
...
tapply(IBM$StockPrice, months(date), mean)
```
